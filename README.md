...
<h3 align="center">🧿 A curated, community-driven list of zero-knowledge resources, tools, and applications built on Aleo. 🧿</h3>
...
<p align="center">
  <em>The one-stop shop for all things Aleo: from zero-knowledge proof basics to advanced tools, apps, and more!</em>
</p>
...
**Aleo** is a platform for fully private, programmable applications using zero-knowledge proofs. This repository is a *community-driven* collection of resources, libraries, and projects showcasing what’s possible in the Aleo ecosystem. Whether you’re a developer, researcher, or just curious about ZK cryptography, we’ve got you covered!  

:fire: **Pro tip:** Want to add your project? Check out our [CONTRIBUTING.md](./CONTRIBUTING.md) for how to submit a pull request.

---

## Table of Contents
Take a quick tour of everything in the Aleo Ecosystem:

- [Announcements & News](#announcements--news) – Stay in the loop.
- [Presentations & Talks](#presentations--talks) – Dive deeper with videos & podcasts.
- [Research Papers & Resources](#research-papers--resources) – For the academically minded.
- [Core Libraries](#core-libraries) – Essential building blocks for Aleo.
- [Development Tools](#development-tools) – Must-have gear for devs.
...
- [Applications](#applications) – Check out the awesome stuff people are building!
  ...
  - [Voting](#voting)
  - [Wallets](#wallets)
  - [Wallets Developer Tools](#wallets-developer-tools)
...
## Announcements & News
> **Stay up-to-date with official Aleo channels and community announcements.**

- [Aleo Discord](https://discord.gg/YtaruFtS) – Join the conversation!
- [Aleo Twitter](https://twitter.com/AleoHQ) – Follow for real-time updates.

---

## Presentations & Talks
> **Videos, podcasts, and deep dives into zero-knowledge and Aleo.**

- [Introduction to zkSNARKs with Howard Wu](https://zeroknowledge.fm/38-2/) – Zero Knowledge Podcast: Episode 38  
- [Demystifying Zero-Knowledge Programming](https://www.youtube.com/watch?v=-FrrylHITvg) – Intro to the Record Model  
...
> **For those who love to geek out on the cryptographic side.**

- [Zexe](https://eprint.iacr.org/2018/962.pdf) – Enabling decentralized private computation  
- [Marlin](https://eprint.iacr.org/2019/1047.pdf) – Preprocessing zkSNARKs with universal/updatable SRS  
- [Leo](https://eprint.iacr.org/2021/651.pdf) – The language powering zero-knowledge apps  
- [Poseidon](https://eprint.iacr.org/2019/458.pdf) – ZK-friendly hash function  
- [AVM Opcodes](https://github.com/AleoHQ/ARCs/tree/master/arc-0002) – Aleo Virtual Machine details  
- [PoNW](https://eprint.iacr.org/2020/190.pdf) – Proof of Necessary Work  

---

## Core Libraries
> **Your foundation for building on Aleo.**

- [SDK](https://github.com/AleoHQ/aleo) – Software Development Kit for ZK transactions  
- [Leo](https://github.com/AleoHQ/leo) – A functional, statically-typed language for ZK apps  
- [snarkOS](https://github.com/AleoHQ/snarkOS) – Decentralized OS for zero-knowledge applications  
- [snarkVM](https://github.com/AleoHQ/snarkVM) – Virtual Machine for ZK executions  

---

## Development Tools
> **Handy resources for crafting, testing, and analyzing Aleo dApps.**

### Decompilers
- [AleoVera](https://github.com/FuzzingLabs/aleovera) – Bytecode analyzer & disassembler  
- [AleoPathy](https://github.com/HH-0rg/aleopath) – Online disassembler & decompiler  

### Hardware Acceleration
- [ZPrize](https://zprize.io/) – Accelerating the future of ZK cryptography  
- [Accelerating MSM on GPUs/FPGAs](https://github.com/z-prize/prize-gpu-fpga-msm) – GPU/FPGA approach to speed up MSM  
- [Accelerating MSM on Mobile](https://github.com/celo-org/zprize-mobile-harness) – MSM acceleration for mobile devices  
...
## Applications
> **A curated collection of Aleo-powered dApps, from DeFi to Gaming and beyond.**

### Algorithms
- [fixed-point numbers](https://github.com/zeroknowledgetutorials/leo-fixed-point-numbers)  
- [is_prime](https://github.com/arosboro/is_prime)  
- [leo/bubblesort](https://github.com/AleoHQ/leo/tree/testnet3/examples/bubblesort)  
- [leo/groups](https://github.com/AleoHQ/leo/tree/testnet3/examples/groups)  
- [leo/twoadicity](https://github.com/AleoHQ/leo/tree/testnet3/examples/twoadicity)  
- [leo-elgamal](https://github.com/ewynx/leo-elgamal) – Homomorphic encryption  
...
### Bridging
- [Eclipse](https://github.com/eqlabs/eclipse) – ZK proofs of Solana votes on Aleo  
- [IZAR](https://github.com/izar-bridge/aleo-contracts) – Privacy-preserving cross-chain interoperability  
- [Gas Zip](https://github.com/gasdotzip) – Bridge solution for Aleo (GMP expansion)  
...
- [Where's Alex](https://github.com/puzzlehq/wheres_alex) – Multiplayer puzzle  
- [Treasure Hunt](https://treasures.puzzle.online/) – Hidden treasure hunts  
- [Super Leo Lig](https://superleolig.online/) – On-chain soccer with secret strategies  
- [Aleo Fortune](https://aleo-fortune.vercel.app/) – Casino games (roulette, etc.)  
- [Puzzle SDK for zkGames](https://docs.puzzle.online/tutorials/build_your_first_zkgame/)  
- [Zenet](https://github.com/ZenetGame/ZenetAleo) – Ancient Egyptian Senet  
- [Battleship](https://github.com/demox-labs/zk-battleship) – ZK-based version of Battleship  
- [CoinFlip](https://github.com/demox-labs/zk-coinflip) – 2-player coin toss  
- [Roulette](https://github.com/Entropy1729/aleo_roulette) – Spin the wheel on-chain  
- [leo/tictactoe](https://github.com/AleoHQ/leo/tree/testnet3/examples/tictactoe)  
- [Boloney](https://github.com/Kryha/boloney) – Multiplayer dice game  
- [ZK Gaming Toolkit](https://github.com/Kryha/zk-gaming-toolkit) – Pre-built Leo primitives  
- [ZK Sudoku Swaps](https://github.com/dorebell/zksudoku) – Maxwell’s ZKCP approach  
- [Aleo Monopoly](https://github.com/Elexy101/Aleo-Monopoly)  
- [Aleo Wordle](https://github.com/pineappleworkshop/aleo-zordle)  
- [Rock, Paper, Scissors](https://github.com/pineappleworkshop/aleo-roshambo)  
- [Sudoku, Wordle, Trivia](https://github.com/ruizehung/Zero-Knowledge-Sudoku-Wordle-Trivia)  
- [ZK Stratego](https://github.com/evan-schott/zk-stratego)  
...
### Governance
- [MACI](https://github.com/Entropy1729/aleo_minimum_anti_collusion_infrastructure) – Anti-collusion infra  
- [Aleo-Vote](https://github.com/zkprivacy/aleo-vote) – ZK voting  
- [leo/vote](https://github.com/AleoHQ/leo/tree/testnet3/examples/vote) – Simple propose & vote example  
- [zk Suggestion Box](https://github.com/demox-labs/zk-suggestion-box) – Anonymous feedback  

### Machine Learning
> **Bringing privacy to ML with ZK proofs.**
...
- [Zero Gravity](https://github.com/zkp-gravity/0g) – Weightless neural network inference  
...
- **zMarket** – *[In development]*  

### NFT Infrastructure
- [Aleo Name Service](https://aleonames.id/) – NFT-based domains  
...
### Oracles
- [Aleo Oracle SDK JS](https://github.com/zkportal/aleo-oracle-sdk-js)  
- [Aleo Oracle SDK GO](https://github.com/zkportal/aleo-oracle-sdk-go)  
- [Aleo Oracle](https://docs.aleooracle.xyz/) – Infra & docs  
- [zkOracle](https://github.com/zkportal) – Oracle project  
- [Pyth Oracle](#) – *[In development]*  
...
- [Puzzle Wallet](https://puzzle.online/wallet) – Mobile & extension wallet  
- [Soter Wallet](https://sotertech.io/) – Privacy-focused  
...
- [MetaMask Snap (Official)](https://snaps.metamask.io/snap/npm/chainsafe/aleo-snap/) – The official Snap  
...
## Contributing
We welcome community contributions to keep this ecosystem list fresh and comprehensive!  
...
<p align="center">
  <strong>Enjoy exploring and building on Aleo!</strong><br>
  <em>Because <u>privacy</u> matters, and <u>innovation</u> never stops.</em>
</p>
